...
export class FollowingComponent implements OnInit {
  ...
  public following: Follow[]; // usuarios que nosotros / el user está siguiendo
  ...
  actualPage() {
    this._route.params.subscribe(params => {
      ...
      if (!page) {
        page = 1;
        this._router.navigate(['/siguiendo', this.userPageId, page]); // si mete un texto como parametro va por aqui
      } else {
